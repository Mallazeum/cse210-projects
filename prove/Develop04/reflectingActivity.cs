public class ReflectingActivity : Activity
{
    ...
    public ReflectingActivity (string name = "Reflecting", string description = "This activity will help you reflect on times in your life when you have shown strength and resilience. This will help you recognize the power you have and how you can use it in other aspects of your life.") : base(name,description)
    {
    ...
    {
        int rand = r.Next(0,_questions.Count());
        Console.WriteLine(_questions[rand]);
    }
}